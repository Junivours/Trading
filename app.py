...
class AdvancedMarketAnalyzer:
    ...
    def _generate_trading_signals(indicators, patterns, ml_predictions, price_data):
        ...
        if macd > macd_signal:
            signals.append({'type': 'BUY', 'strength': 'MEDIUM', 'reason': 'MACD Bullish'})
        else:
            signals.append({'type': 'SELL', 'strength': 'MEDIUM', 'reason': 'MACD Bearish'})
    ...
    def _calculate_trading_kpis(indicators, patterns, price_data, volume_data):
        ...
        return {
            ...
            'trend_strength': indicators.get('current_adx', 0),
            'volume_trend': 1.0 if len(volume_data) > 1 else 0.0
        }
    ...
    def _detect_market_state(indicators, price_data, volume_data):
        ...
        volatility = indicators.get('current_atr', 0)
