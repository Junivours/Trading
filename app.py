...
<body>
        ...
        <div class="controls">
            <div class="controls-row">
                <div class="input-group">
                    ...
                    <input type="text" id="coinInput" value="BTCUSDT" placeholder="z.B. BTCUSDT" onkeypress="if(event.key==='Enter') quickAnalyze()">
                </div>
                ...
                <div class="watchlist-section">
                    ...
                    <div class="watchlist">
                        <div class="watchlist-item" onclick="selectSymbol('BTCUSDT')">BTC</div>
                        <div class="watchlist-item" onclick="selectSymbol('ETHUSDT')">ETH</div>
                        <div class="watchlist-item" onclick="selectSymbol('BNBUSDT')">BNB</div>
                        <div class="watchlist-item" onclick="selectSymbol('SOLUSDT')">SOL</div>
                        <div class="watchlist-item" onclick="selectSymbol('ADAUSDT')">ADA</div>
                        <div class="watchlist-item" onclick="selectSymbol('XRPUSDT')">XRP</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function quickAnalyze() {
            console.log('Quick analyze triggered');
            analyzeSymbol();
        }
