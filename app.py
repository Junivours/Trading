...
<body>
    ...
    <script>
                ...
                <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 1.5rem; align-items: center;">
                    <div class="trading-score-gauge">
                        ...
                        <div class="gauge-text">
                            <div style="font-size: 1.4rem; color: ${getScoreColor(tradingScore)}">${formatDecimal(tradingScore, 0)}</div>
        ...
        function formatScore(value, maxValue) {
            if (value === null || value === undefined || isNaN(value)) return `0/${maxValue}`;
            return `${formatDecimal(value, 1)}/${maxValue}`;
        }
